...
namespace Wim.Module.MailTemplate.UI
{
    ...
    public class SendTestMail_List : Wim.Framework.ComponentListTemplate
    {
        ...
        private void SendTestMail_List_ListPreRender(Framework.IComponentListTemplate sender, Framework.ComponentListEventArgs e)
        {
        ...
        private void SendTestMail_List_ListSave(Framework.IComponentListTemplate sender, Framework.ComponentListEventArgs e)
        {
            var idQueryString = Request.QueryString["item"];
        ...
        private void SendTestMail_List_ListLoad(Framework.IComponentListTemplate sender, Framework.ComponentListEventArgs e)
        {
